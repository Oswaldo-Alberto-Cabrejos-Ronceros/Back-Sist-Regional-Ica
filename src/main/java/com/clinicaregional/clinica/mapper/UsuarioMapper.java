...
public class UsuarioMapper {
    ...
    public Usuario mapFromUsuarioRequestDTOToUsuario(UsuarioRequestDTO usuarioRequestDTO) {
        return new Usuario(null,usuarioRequestDTO.getNombre(),usuarioRequestDTO.getCorreo(),usuarioRequestDTO.getContrasena(),usuarioRequestDTO.isEstado(),rolMapper.mapToRol(usuarioRequestDTO.getRol()));
    }
