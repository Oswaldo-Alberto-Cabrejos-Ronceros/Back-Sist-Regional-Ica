        ...
        return http.csrf(csrf -> csrf.disable())
                ...
                .authorizeHttpRequests(httpRequest -> {
                    httpRequest
                            ...
                            .requestMatchers(HttpMethod.GET, "/api/citas/citas-medico/**").hasAnyAuthority("MEDICO", "RECEPCIONISTA")
                            ...
                            .requestMatchers(HttpMethod.PUT, "/api/citas/reprogramar/**").hasAnyAuthority("MEDICO", "RECEPCIONISTA")
                            .requestMatchers(HttpMethod.GET, "/api/citas/medico/*/pacientes").hasAnyAuthority("MEDICO", "RECEPCIONISTA","ADMIN")
                            .requestMatchers(HttpMethod.GET, "/api/citas/paciente/*/citas-futuras").hasAuthority("PACIENTE")
                            .requestMatchers(HttpMethod.PUT, "/api/citas/*").hasAnyAuthority("PACIENTE", "MEDICO", "RECEPCIONISTA")
                            .requestMatchers(HttpMethod.DELETE, "/api/citas/*").hasAnyAuthority("PACIENTE", "MEDICO", "RECEPCIONISTA")

                            .requestMatchers("/api/coberturas/**").hasAuthority("ADMIN")
                            .requestMatchers("/api/disponibilidad/**").hasAnyAuthority("ADMIN", "MEDICO", "RECEPCIONISTA")
                            .requestMatchers("/api/especialidades/**").hasAuthority("ADMIN")
                            .requestMatchers("/api/horario-bloques/**").hasAnyAuthority("ADMIN", "MEDICO", "RECEPCIONISTA")
