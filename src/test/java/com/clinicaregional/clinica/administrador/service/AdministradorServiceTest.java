...
class AdministradorServiceTest {
    ...
    void getAdministradorById_existente() {
        ...
        when(administradorMapper.mapToAdministradorDTO(admin)).thenReturn(
                new AdministradorDTO(1L, "Nombre", "Apellido", "12345678", 1L, "999", "Calle","administrador.jpg" ,LocalDate.now(), 1L));
    ...
    void updateAdministrador_documentoDuplicado() {
        AdministradorDTO dto = new AdministradorDTO(1L, "N", "A", "999", 1L, "999", "D","administrador.jpg", LocalDate.now(), 1L);
