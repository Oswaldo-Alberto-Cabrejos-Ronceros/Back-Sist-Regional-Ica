...
class AlergiaServiceImplTest {
    ...
    // TEST DE RESPUESTA NEGATIVA
    @Test
    @DisplayName("Guardar alergia con nombre existente debe lanzar excepción")
    void guardarAlergia_conNombreExistente_debeLanzarExcepcion() {
        // Arrange
        AlergiaDTO dtoEntrada = new AlergiaDTO(null, "Polvo", TipoAlergia.AMBIENTAL);
        when(alergiaRepository.existsByNombreAndEstadoIsTrue("Polvo")).thenReturn(true);
    ...
    @Test
    @DisplayName("Buscar alergia por ID inexistente debe lanzar excepción")
    void buscarAlergiaPorId_inexistente_debeLanzarExcepcion() {
        // Arrange
    ...
    @Test
    @DisplayName("Actualizar alergia inexistente debe lanzar excepción")
    void actualizarAlergia_inexistente_debeLanzarExcepcion() {
        // Arrange
        when(alergiaRepository.findByIdAndEstadoIsTrue(99L)).thenReturn(Optional.empty());
    ...
    @Test
    @DisplayName("Actualizar alergia con nombre duplicado debe lanzar excepción")
    void actualizarAlergia_conNombreDuplicado_debeLanzarExcepcion() {
        // Arrange
        Alergia alergiaExistente = Alergia.builder()
                .id(1L)
                .nombre("Polvo")
    ...
    @Test
    @DisplayName("Eliminar alergia inexistente debe lanzar excepción")
    void eliminarAlergia_inexistente_debeLanzarExcepcion() {
        // Arrange
        when(alergiaRepository.findByIdAndEstadoIsTrue(99L)).thenReturn(Optional.empty());
