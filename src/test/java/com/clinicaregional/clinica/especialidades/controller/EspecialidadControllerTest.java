...
class EspecialidadControllerTest {
        ...
        @BeforeEach
        void setUp() {
                especialidadResponse = new EspecialidadResponse(1L, "Cardiología", "Problemas del corazón",
                                "cardio.jpg");
        ...
        void crearEspecialidad() throws Exception {
                // Arrange
                when(especialidadService.guardarEspecialidad(any(EspecialidadRequest.class)))
        ...
        void crearEspecialidad_datosInvalidos() throws Exception {
                // Arrange
                EspecialidadRequest requestInvalido = new EspecialidadRequest("", "", ""); // nombre y descripcion
                                                                                           // vacíos
