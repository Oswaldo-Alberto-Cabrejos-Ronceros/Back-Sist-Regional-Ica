...
class RecepcionistaServiceTest {
    ...
    @Mock private RecepcionistaMapper recepcionistaMapper;
    ...
    void eliminarRecepcionista_existente() {
        ...
        Recepcionista recepcionista = new Recepcionista();
        recepcionista.setId(1L); recepcionista.setUsuario(usuario); recepcionista.setEstado(true);
        when(recepcionistaRepository.findByIdAndEstadoIsTrue(1L)).thenReturn(Optional.of(recepcionista));
    ...
    void actualizarRecepcionista_inexistente_lanzaExcepcion() {
        ...
        // Act & Assert
        assertThrows(RuntimeException.class, () -> recepcionistaService.actualizar(99L, req));
    }
}
